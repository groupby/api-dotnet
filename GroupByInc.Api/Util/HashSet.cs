...
namespace GroupByInc.Api.Util
{
    public class HashSet<T> : ICollection<T>, ISerializable, IDeserializationCallback
    {
        ...
        public HashSet<T> NullSet
        {
            get { return new HashSet<T>(); }
        }
        ...
        /// <summary>
        ///     Copies the items of the <see cref="T:System.Collections.Generic.ICollection`1" /> to an
        ///     <see cref="T:System.Array" />, starting at a particular <see cref="T:System.Array" /> index.
        /// </summary>
        /// <param name="array">
        ///     The one-dimensional <see cref="T:System.Array" /> that is the destination of the items copied from
        ...
        ///     of items in the source <see cref="T:System.Collections.Generic.ICollection`1" /> is greater than the available
