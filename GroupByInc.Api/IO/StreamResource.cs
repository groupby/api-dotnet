...
namespace GroupByInc.Api.IO
{
	...
	/// <remarks>
	/// <para>
	/// In contrast to other <see cref="IResource"/> implementations, 
    /// this is an adapter for an already opened resource - the <see cref="IResource.IsOpen"/> 
	...
	public class StreamResource : IResource
	{
		...
		/// <summary>
		/// Creates a new instance of the <see cref="StreamResource"/> class.
		/// </summary>
