...
{
    /// <summary>
    ///     Unit tests for the <see cref="MediaType" /> class.
    /// </summary>
    /// <author>
    ///     Arjen Poutsma
    /// </author>
    ...
    public class MediaTypeTests
    {
        ...
        public void CompareTo()
        {
            ...
            MediaType audioBasicLevel = new MediaType("audio", "basic", SingletonDictionary("level", "1"));
        ...
        public void CompareToCaseSensitivity()
        {
            ...
            m1 = new MediaType("audio", "basic", SingletonDictionary("foo", "bar"));
            m2 = new MediaType("audio", "basic", SingletonDictionary("Foo", "bar"));
            Assert.AreEqual(0, m1.CompareTo(m2), "Invalid comparison result");
            Assert.AreEqual(0, m2.CompareTo(m1), "Invalid comparison result");
