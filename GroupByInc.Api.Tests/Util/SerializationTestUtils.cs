...
namespace GroupByInc.Api.Tests.Util
{
    /// <summary>
    ///     Utilities for testing serializability of objects.
    /// </summary>
    /// <remarks>
    ///     Exposes <see langword="static" /> methods for use in other test cases.
    /// </remarks>
    /// <author>
    ///     Rod Johnson
    /// </author>
    ...
    public sealed class SerializationTestUtils
    {
        ...
        /// <returns>
        ///     <see langword="true" /> if the object is serializable, otherwise
        ///     false.
        /// </returns>
